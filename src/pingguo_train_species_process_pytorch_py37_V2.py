...
img_size = 224
species = 'pingguo'
train_folder = './train-class-desease/pingguo'
valid_folder = './valid-class-desease/pingguo-v'
...
model = ShuffleNetV2(scale=1.5, in_channels=12, c_tag=0.5, num_classes=6, activation=nn.ReLU, SE=True, residual=False)

train_model(model, 100, t)
