...
img_size = 224
species = 'putao'
train_folder = './train-class-desease/putao'
valid_folder = './valid-class-desease/putao-v'
...
model = ShuffleNetV2(scale=1.5, in_channels=12, c_tag=0.5, num_classes=7, activation=nn.ReLU, SE=False, residual=False)
