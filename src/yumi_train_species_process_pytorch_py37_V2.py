...
img_size = 224
species = 'yumi'
train_folder = './train-class-desease/yumi'
valid_folder = './valid-class-desease/yumi-v'
...
model = ShuffleNetV2(scale=1.5, in_channels=12, c_tag=0.5, num_classes=8, activation=nn.ReLU, SE=False, residual=False)
