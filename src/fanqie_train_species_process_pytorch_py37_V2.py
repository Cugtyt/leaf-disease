...
img_size = 224
species = 'fanqie'
train_folder = './train-class-desease/fanqie'
valid_folder = './valid-class-desease/fanqie-v'
...
model = ShuffleNetV2(scale=1.5, in_channels=12, c_tag=0.5, num_classes=20, activation=nn.ReLU, SE=False, residual=False)
