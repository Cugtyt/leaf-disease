...
img_size = 224
species = 'tao'
train_folder = './train-class-desease/tao'
valid_folder = './valid-class-desease/tao-v'
...
model = ShuffleNetV2(scale=1, in_channels=12, c_tag=0.5, num_classes=3, activation=nn.ReLU, SE=False, residual=False)
