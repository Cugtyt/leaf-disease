...
img_size = 224
species = 'malinshu'
train_folder = './train-class-desease/malinshu'
valid_folder = './valid-class-desease/malinshu-v'
...
model = ShuffleNetV2(scale=1.5, in_channels=9, c_tag=0.5, num_classes=5, activation=nn.ReLU, SE=False, residual=False)
