...
img_size = 224
species = 'fanqie'
train_folder = './train-class-desease/fanqie-only-disease'
valid_folder = './valid-class-desease/fanqie-only-disease-v'
...
model = ShuffleNetV2(scale=1.5, in_channels=15, c_tag=0.5, num_classes=11, activation=nn.ReLU, SE=False, residual=False)

train_model(model, 70, t)
