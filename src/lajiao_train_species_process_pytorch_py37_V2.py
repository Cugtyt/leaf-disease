...
img_size = 224
species = 'lajiao'
train_folder = './train-class-desease/lajiao'
valid_folder = './valid-class-desease/lajiao-v'
...
model = ShuffleNetV2(scale=1.5, in_channels=9, c_tag=0.5, num_classes=3, activation=nn.ReLU, SE=False, residual=False)
